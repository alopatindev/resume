...
\item Concurrency, Parallelism, \bfseries Multithreading\mdseries, MapReduce, \bfseries Reactive \mdseries Programming
...
\begin{itemize}[rightmargin=\dimexpr\linewidth-17.5cm-\leftmargin\relax]
    \item \bfseries Programming\mdseries
        ...
        limited experience with Perl,~Lua,~Haskell~and~\bfseries Rust\mdseries
