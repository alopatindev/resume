...
\begin{itemize}[rightmargin=\dimexpr\linewidth-18cm-\leftmargin\relax]
    \item \bfseries 4.5+ years \mdseries of industry Software Engineering experience
    \item looking for Software Development Opportunities with a focus on Free/Libre and Open Source Software
    \item interest
    \begin{itemize}[rightmargin=\dimexpr\linewidth-18cm-\leftmargin\relax]
        \item GNU/\bfseries Linux \mdseries (both Client and Server)
...
\section*{Skills}
    ...
    \vspace{0.4cm}
    \bfseries Tools and Technologies\mdseries
    \begin{adjustwidth}{15pt}{20pt}
        ...
        JNI,
        SQLite,
        limited experience with OpenGL
        and more
    \end{adjustwidth}
...
\section*{Education}
\begin{itemize}
    \item 2016 \href{https://alopatindev.github.io/2016/11/29/self-learning}{Various MOOC / video courses (Concurrency, OOP, FP, Algorithms, Math, etc.)}
