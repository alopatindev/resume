...
\begin{itemize}[rightmargin=\dimexpr\linewidth-18cm-\leftmargin\relax]
    ...
    \item interest in \bfseries low-level problems \mdseries (Memory, Performance, Concurrency, OS and Hardware-specific, etc.)
    \item interest in Software Design principles (FP, OOP, Event-Driven, etc.)
...
\begin{itemize}[rightmargin=\dimexpr\linewidth-17.5cm-\leftmargin\relax]
    ...
    \item \bfseries Tools\mdseries
        ...
        limited experience with IPython~Notebook/\bfseries Jupyter\mdseries,
        {\LaTeX }
        and more
\end{itemize}
