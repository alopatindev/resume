...
\section*{Skills}
    ...
    \begin{itemize}[rightmargin=\dimexpr\linewidth-17.5cm-\leftmargin\relax]
        \item intermediate: C, \bfseries C++\mdseries, Objective-C, Java, \bfseries Scala\mdseries,
            \bfseries Python \mdseries and UNIX shell/\bfseries bash \mdseries scripting
        \item beginner: \bfseries JavaScript/\mdseries ECMAScript,~\bfseries Rust\mdseries~and~Haskell
    \end{itemize}

    \vspace{0.4cm}
    \bfseries Platforms, Frameworks, Libraries\mdseries
